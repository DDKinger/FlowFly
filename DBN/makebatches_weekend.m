load ./data/X_input_weekend_69k2
load ./data/Y_output_weekend_69k2
X_input = X_input_weekend;
Y_output = Y_output_weekend;
...
INPUT_train = X_input(1:5184,:);
INPUT_test = X_input(5184:end,:);
Y_train = Y_output(1:5184,:);
Y_test = Y_output(5184:end,:);
